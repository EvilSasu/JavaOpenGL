...
public class Maths {
    ...
    // odpowiada macierz transformacji umozliwia transformacje obiektow
    ...
    public static Matrix4f createViewMatrix(Kamera kamera){
        Matrix4f viewMatrix = new Matrix4f();
        viewMatrix.setIdentity();
        Matrix4f.rotate((float) Math.toRadians(kamera.getPitch()), new Vector3f(1, 0, 0), viewMatrix, viewMatrix);
